    ...
    .then(data => {
        for(let i = 0;i<data.length;i++){
            ...
            clon.querySelector('button').onclick = function(){
                ...
                setTimeout(function(){
                    document.querySelector("aside").classList.remove("animaparece")
                    document.querySelector("aside").classList.add("animaesconde")
                    setTimeout(function(){
                        document.querySelector("aside").classList.remove("animaesconde")
                    },5000)
                },5000)
